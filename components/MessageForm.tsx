      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-[14px] mb-[30px]">
        <div className="relative">
          <textarea
            ...
            rows={3}
            className={`
              w-full bg-transparent border rounded-[6px] text-white
              font-mono text-[12px] px-4 py-4 outline-none
              placeholder-[#444] transition-colors resize-none
              ${overLimit ? 'border-[#553333]' : 'border-[#333] focus:border-[#555]'}
            `}
            disabled={loading}
          />
          <div
            className={`
              ...
              ${overLimit
                ? 'text-[#aa5555]'
                : wordCount > 80 ? 'text-[#666]' : 'text-[#333]'
              }
            `}
          >
            {wordCount}/{MAX_WORDS}
        ...
        {error && (
          <p className="font-mono text-[11px] text-[#666]">{error}</p>
        )}
        ...
        <button
          ...
          className="
            w-full bg-transparent border border-white rounded-[6px]
            text-white font-serif text-[16px] font-bold py-[17px]
            transition-all hover:bg-white hover:text-[#0a0a0a]
